...
class Parameters:
    ...
    def load_connectionparams(self):
        ...
        params['B'] = 0.93
        params['A'] = 37
        params['sigma_r'] = 0.63 # I think this is the sigma_log(R)
        params['n'] = 1.07
...
class Halos():
    def __init__(self, pair):
        """Pair is either RJ (Romeo and Juliet), TL (Thelma and Louise), or RR (Romulus and Remus)"""
        self.pair = pair
    ...
    def mw_disk(self, n_points=1000):
        """Estimate location of MW disk by finding plane perpendicular to the MW DM halo angular momentum vector"""
        jx = self.MW['jx']
        jy = self.MW['jy']
        jz = self.MW['jz']
